...
const StudentDashboard = () => {
  ...
  useEffect(() => {
    // Any initial effects can be placed here
  }, [navigate]);
  ...
  const handleSignOut = () => {
    //alert('The QTMUN Portal is still in Alpha stage, when you sign out, you will be redirected to the login page.');
    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-purple-900 p-4 animate-fadeIn">
      <div className="w-full max-w-6xl bg-blue-950 bg-opacity-30 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-blue-400 border-opacity-20">
        <header className="flex justify-between items-center mb-8">
          <h1 className="text-4xl font-bold text-white">QTMUN Portal</h1>
          <div className="flex items-center space-x-4">
            ...
            <div className="relative dropdown-container">
              ...
              >
                <img src="/api/placeholder/48/48" alt="User portrait" className="w-full h-full object-cover" />
              </button>
